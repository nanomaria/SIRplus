...
k = .5;
Tfin = 500;
dc = .1;  % choose 0.1 for smooth curves
...
p1 = 1;%0.3/gamma*(alpha_standard/0.2);
p2 = 1.3;%.42/gamma*(alpha_standard/0.2);
p3 = 2;%/gamma*(alpha_standard/0.2);
p4 = 4;%/gamma*(alpha_standard/0.2);
