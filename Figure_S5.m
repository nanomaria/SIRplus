...
yyaxis left
plot(Cv,betav2(4,:),'Color',[0.592 0.054 0.325],'Linestyle','-.','Linewidth',1.8)
hold on
line(Cv,betav2(3,:),'Color',[0.592 0.054 0.325],'Linestyle','-.','Linewidth',1.4)
hold on
line(Cv,betav2(2,:),'Color',[0.592 0.054 0.325],'Linestyle','-.','Linewidth',1)
hold on
line(Cv,betav2(1,:),'Color',[0.592 0.054 0.325],'Linestyle','-.','Linewidth',0.6)
hold on
...
d1=line([ Dmaxi*delta/kv(1),Cv(end)],[p1,p1],   'Color',[0.592 0.054 0.325],'Linestyle','-','LineWidth',thc);
d1.Color(4) = tcy;
hold on
d2=line([ Dmaxi*delta/kv(2),Cv(end)],[p2,p2], 'Color',[0.592 0.054 0.325],'Linestyle','-','LineWidth',thc);
d2.Color(4) = tcy;
hold on
d3=line([ Dmaxi*delta/kv(3),Cv(end)],[p3,p3],   'Color',[0.592 0.054 0.325],'Linestyle','-','LineWidth',thc);
d3.Color(4) = tcy;
hold on
d4=line([ Dmaxi*delta/kv(4),Cv(end)],[p4,p4], 'Color',[0.592 0.054 0.325],'Linestyle','-','LineWidth',thc);
d4.Color(4) = tcy;
hold on
